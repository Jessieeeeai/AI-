...
const Step4SegmentationConfirm = ({ data, setData, onNext, onPrev }) => {
      ...
      const renderPlayButton = (segment) => {
              if (currentPlayingSegment === segment.id) {
                        return (
      ...
      const renderGenerateButton = (segment) => {
