                          ...
                          <div className="max-w-7xl mx-auto p-6">
                                ...
                                <div className="grid grid-cols-3 gap-6">
                                        <div className="space-y-4">
                                                  <h3 className="text-lg font-semibold flex items-center gap-2">
                                                              <Volume2 className="w-5 h-5" />选择声音
                                                  </h3>h3>
                                        ...
                                        <div className="col-span-2 space-y-4">
                                                  ...
                                                  <div className="p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200">
                                                    ...
                                                    <span className="flex items-center gap-2 text-green-600 font-semibold">
                                                                      <CheckCircle className="w-5 h-5" />全部确认完成！
                                                    </span>span>
                                                                            )}
                                                              </div>div>
                                                  </div>div>
                                ...
                                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                        <p className="text-sm text-blue-800">
                                                  💡 <strong>提示：</strong>strong>点击每段右侧的生成试听按钮，逐段生成语音并试听。如果对某段效果不满意，可以点击重新生成直到满意为止。所有分段确认后，才能进入下一步生成视频。
                                        </p>p>
                                </div>div>
                                ...
                                <div className="flex justify-between pt-6">
                                        ...
                                        <button type="button" onClick={handleNext} disabled={!allSegmentsReady} className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 disabled:from-gray-300 disabled:to-gray-300 transition-all">
                                                  下一步：选择视频模板<ArrowRight className="w-4 h-4" />
                                        </button>button>
                                </div>div>
                          </div>div>
                        );
